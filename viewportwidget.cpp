...
void ViewPortWidget::drawObject(){
    ...
    if(triangleMesh!=NULL)
    {
        ...
        std::vector<TriangleMesh::HE_edge>::iterator iv = triangleMesh->edgeVector->begin();
...
void ViewPortWidget::drawFace(TriangleMesh::HE_edge* edge){
    if(edge!=NULL && edge->face!=NULL){
        TriangleMesh::HE_face* face = edge->face;
        TriangleMesh::Normal* face_normal = face->normal;
        TriangleMesh::HE_vert* v0 = face->edge->vert;
        TriangleMesh::HE_vert* v1 = face->edge->next->vert;
        TriangleMesh::HE_vert* v2 = face->edge->prev->vert;
        TriangleMesh::Normal* v0_normal = v0->normal;
        TriangleMesh::Normal* v1_normal = v1->normal;
        TriangleMesh::Normal* v2_normal = v2->normal;
        ...
        {
            glNormal3f(v0_normal->x,v0_normal->y,v0_normal->z);
        }
        ...
        {
            glNormal3f(v1_normal->x,v1_normal->y,v1_normal->z);
        }
        ...
        {
            glNormal3f(v2_normal->x,v2_normal->y,v2_normal->z);
        }
...
void ViewPortWidget::traverse_halfedge(TriangleMesh::HE_edge* edge){
    TriangleMesh::HE_edge* outgoing_he = edge;
    TriangleMesh::HE_edge* curr = outgoing_he;
